...
var infrastructureInitialized = false
...
func setupInfrastructure() error {
	...
	if err != nil {
		return errors.New("Couldn't merge labels into one file: " + err.Error())
	}
	...
	if err != nil {
		return errors.New("Couldn't merge metalabels into one file: " + err.Error())
	}

	db = NewImageMonkeyDatabase()
	err = db.Initialize()
	if err != nil {
		return errors.New("Couldn't initialize database: " + err.Error())
	}
	...
	redisPool := redis.NewPool(func() (redis.Conn, error) {
		...
		if err != nil {
			return c, errors.New("Couldn't dial redis: " + err.Error())
		}
	...
	if err != nil {
		return errors.New("Couldn't publish message: " + err.Error())
	}
