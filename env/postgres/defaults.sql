...
CREATE TYPE label_bot_state_type AS ENUM ('pending', 'building', 'build-failed', 'build-success', 'waiting for moderator approval', 'accepted', 'retry', 'build-canceled', 'already exists', 'merged', 'productive');
