...
func NewLabelsRepository(projectOwner string, repositoryName string, gitCheckoutDir string) *LabelsRepository {
	return &LabelsRepository{
		...
		autoGeneratedLabelsWriter: NewLabelsWriter(gitCheckoutDir + "/autogenerated_labels.libsonnet"),
		autoGeneratedMetaLabelsWriter: NewMetaLabelsWriter(gitCheckoutDir + "/autogenerated_metalabels.libsonnet"),
	}
}
