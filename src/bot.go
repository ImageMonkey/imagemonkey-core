...
type LabelsRepository struct {
	...
	autoGeneratedLabelsWriter *commons.LabelsWriter
	autoGeneratedMetaLabelsWriter *commons.MetaLabelsWriter
}
...
func NewLabelsRepository(projectOwner string, repositoryName string, gitCheckoutDir string) *LabelsRepository {
	return &LabelsRepository{
		...
		autoGeneratedLabelsWriter: commons.NewLabelsWriter(gitCheckoutDir + "/autogenerated_labels.libsonnet"),
		autoGeneratedMetaLabelsWriter: commons.NewMetaLabelsWriter(gitCheckoutDir + "/autogenerated_metalabels.libsonnet"),
	}
}
